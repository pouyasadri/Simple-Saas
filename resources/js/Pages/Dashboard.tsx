...
import {PageProps, UsedFeatures} from '@/types';

export default function Dashboard({auth, usedFeatures}: { auth: PageProps['auth'], usedFeatures: UsedFeatures }) {
    return (
        <AuthenticatedLayout
            user={auth.user}
                                ...
                                {usedFeatures.data.length === 0 && (
                                    <tr>
                                        <td colSpan={4} className={"p-8 text-center"}>
                                            You don't used any feature yet.
                                        </td>
                                    </tr>
                                )}
                                </tbody>
